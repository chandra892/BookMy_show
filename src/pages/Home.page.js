...
<div className="bg-NavCol-200 py-16">
  <div className="container mx-auto px-4 "> 
    <div className="flex ">
       ...
       <PostSlider images={TempPoster} title="Premiers" subtitle="Brand Releases Every Friday" isDark /> 
    </div>
  </div>
</div>
</div>
...
<PostSlider images={TempPoster} title="Online Streaming Events" isDark={false}/> 
</div>


<div className="container m-auto px-4">
<PostSlider images={TempPoster} title="Outdoor Events" isDark={false}/> 
</div> 
